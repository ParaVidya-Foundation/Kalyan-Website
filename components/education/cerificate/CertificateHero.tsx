  ...
  return (
    <section className="relative w-full overflow-hidden pt-36">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <p className="mt-8 text-lg md:text-xl leading-relaxed text-slate-700 max-w-3xl mx-auto">
          A structured, exam-based astrology certification designed for
          practitioners who value depth, discipline, and professional
          credibility.
        </p>
