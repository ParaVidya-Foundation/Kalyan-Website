...
const TestSection: React.FC<Props> = ({ onSubmitEmail }) => {
  ...
  return (
    <section
      className="relative mb-6 mx-auto w-[95%] overflow-hidden rounded-3xl bg-white py-16 sm:py-20 md:py-24"
          ...
          >
            <div className="relative flex-1 w-full">
              <input
                ...
                className="w-full rounded-2xl border border-gray-200 bg-white/80 px-4 py-3 text-base text-gray-900 shadow-sm outline-none placeholder:text-gray-400 backdrop-blur focus:border-gray-300 focus:ring-2 focus:ring-yellow-400/40"
              />
              {emailIsValid && (
                <span className="absolute inset-y-0 right-3 my-auto hidden h-6 w-6 items-center justify-center rounded-full bg-green-500/10 text-green-600 ring-1 ring-green-500/20 sm:flex">
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 24 24"
