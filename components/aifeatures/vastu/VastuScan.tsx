...
export default function VastuScan() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <div className="mb-5">
              <TrueFocus
                sentence="Elevate Your Home Wellness"
                manualMode={false}
                blurAmount={3}
                borderColor="#8b5a2b"
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-[#8b5a2b] leading-tight">
              Unlock Harmony, Prosperity & Peace
            </h2>

            {/* Description */}
            <p className="mt-6 text-lg leading-relaxed text-[#5f4633]">
              Get instant Vastu analysis for your property in minutes.
          ...
          <div className="relative flex justify-center md:justify-end">
            <div className="relative w-[320px] h-[320px] md:w-[440px] md:h-[440px] overflow-hidden rounded-3xl animate-[float_6s_ease-in-out_infinite]">
              <Image
                src="/AI/Vastu/scan.webp"
                alt="Vastu Scan Floor Plan"
                fill
                priority
