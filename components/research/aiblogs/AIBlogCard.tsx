  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Image
              ...
              loading="lazy"
              decoding="async"
              className="object-cover rounded-3xl transition-transform duration-[1600ms] ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:scale-110"
        ...
        <div className="flex flex-col items-start text-left px-2 sm:px-0">
          {category && (
            <p className="text-[11px] sm:text-xs font-medium uppercase tracking-[0.15em] text-gray-500 mb-2">
              {category}
            </p>
          )}
        ...
        <motion.div
          className="absolute inset-0 rounded-3xl bg-gradient-to-br from-amber-200/0 via-yellow-300/0 to-amber-300/0 opacity-0 group-hover:opacity-30 blur-2xl transition-all duration-[1400ms] -z-10"
