...
export default function AIBlogSidebar({
  ...
  const handleCatClick = (cat?: string) => onCategoryChange?.(cat);
  ...
  return (
    ...
    >
        ...
        <motion.section
          ...
          className="relative rounded-2xl bg-white/80 backdrop-blur-md border border-gray-100 p-5"
          itemScope
          ...
          >
            <motion.li>
              <button
                ...
                className={`inline-flex items-center gap-2 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-sky-300 px-1 py-1 rounded ${
                  !activeCategory
        ...
        <motion.section
          variants={fadeUp as any}
          className="mt-6 rounded-2xl bg-white/70 backdrop-blur-md border border-gray-100 p-5"
          role="region"
        ...
        >
          ...
          <Link
            href="/contact"
            className="mt-4 inline-flex items-center justify-between w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-800 hover:bg-sky-600 hover:text-white transition-colors"
        ...
        >
          ...
          <Link
            ...
            aria-label="Read more about Kalyan"
          >
            Learn more →
          </Link>
