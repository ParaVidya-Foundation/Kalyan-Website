    ...
    >
      <div className="flex items-start gap-4 sm:gap-5">
        ...
        <div className="min-w-0">
          <h3
            itemProp="name"
            className="text-[15px] sm:text-[16px] font-semibold tracking-tight text-neutral-900 dark:text-neutral-100"
          >
            {name}
          </h3>
          <p
            className="mt-0.5 text-[12px] sm:text-[13px] text-neutral-600 dark:text-neutral-400"
            itemProp="jobTitle"
          >
            {status}
          </p>
      ...
      {/* Bio */}
      <div
        className="mt-4 text-[13px] text-neutral-800/90 dark:text-neutral-200/90"
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-5 right-5 bottom-3 h-5 rounded-full bg-violet-400/15 blur-md"
      />
    </motion.aside>
  );
}
