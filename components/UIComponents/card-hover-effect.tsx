  ...
  return (
    ...
    >
      <AnimatePresence>
        {active && (
          <motion.span
            className="absolute inset-0 block rounded-3xl bg-gradient-to-br from-violet-50 via-fuchsia-50 to-amber-50"
      ...
      <div
        className={cn(
          "cardFx relative z-10 rounded-2xl overflow-hidden",
          "aspect-[5/4] w-full",
