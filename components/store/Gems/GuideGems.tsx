...
export default function HeroGemContact({
  imageSrc,
  title = "Shop by Profession",
  subtitle = "If you are confused which gem to choose — we can help.",
  ctaText = "Contact Us",
  ctaHref = "/contact",
  height = "min-h-[50vh]",
  className = "",
  ...
  return (
    <header
      aria-label="Hero contact banner"
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center">
        <div className="w-[90%] max-w-6xl mx-auto">
          ...
          <h1
            id="hero-title"
            className={`${playfair.className} text-4xl md:text-5xl lg:text-6xl font-semibold text-black/90 leading-tight tracking-tight`}
          >
            {title}
          </h1>
          ...
          {/* Subtitle */}
          <p
            className={`${inter.className} mt-4 text-base md:text-lg text-black/75 max-w-3xl mx-auto`}
          >
            {subtitle}
          </p>
          ...
          <div className="mt-8 flex justify-center">
            ...
            ctaHref.startsWith("tel:") ? (
              <a
                href={ctaHref}
                className="px-8 py-3 bg-black text-white text-sm md:text-base font-medium tracking-wide uppercase shadow-lg hover:shadow-xl transition-all duration-300 hover:translate-y-[-2px] active:translate-y-[1px]"
              >
                {ctaText}
              </a>
            ) : (
