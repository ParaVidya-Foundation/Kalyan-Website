      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-24 grid grid-cols-1 lg:grid-cols-5 gap-20 items-center">
              ...
              return (
                ...
                >
                  <Image
                    ...
                    alt={z.title}
                    fill
                    sizes="(max-width:640px) 48vw, (max-width:1024px) 25vw, 170px"
        ...
        <div className="lg:col-span-2 flex flex-col items-center justify-center">
          ...
          <motion.p
            ...
            className="mt-14 max-w-md text-center text-gray-700 italic text-sm sm:text-base leading-relaxed"
          >
            {zodiac.desc}
          </motion.p>
        </div>
