        ...
        <div className="mb-6">
          <div className="w-full rounded-lg bg-neutral-50 py-3 px-4 flex flex-wrap gap-4 justify-center border border-neutral-200">
            {badges.map((b, i) => (
              <span
                key={b + i}
                className="inline-flex items-center gap-2 text-[0.9rem] font-medium text-amber-700"
          ...
          >
            ...
            <div className="mt-6 border-t pt-5 flex items-center gap-4">
              ...
              <button
                ...
                onClick={() => alert("View Certificate / Quality Check")}
              >
                Quality Check
              </button>
              ...
              <button
                ...
                onClick={() => alert("Download Size Guide")}
              >
                Size Guide
              </button>
        ...
        >
          <div className="bg-white p-6 rounded-lg">
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <button
                className="px-5 py-2 rounded-md bg-amber-700 text-white text-sm shadow-sm hover:shadow-md transition"
              ...
              <button
                className="px-5 py-2 rounded-md border border-amber-700 text-amber-700 text-sm hover:bg-amber-50 transition"
              ...
              <button
                className="px-5 py-2 rounded-md border border-neutral-300 text-neutral-700 text-sm hover:bg-neutral-100 transition"
                onClick={() => alert("Customize Your Poster")}
              >
                Custom Poster
              </button>

              <button
                className="px-5 py-2 rounded-md border border-blue-600 text-blue-600 text-sm hover:bg-blue-50 transition"
                onClick={() => alert("Preview in Your Room (AR)")}
              >
                AR Preview
              </button>
