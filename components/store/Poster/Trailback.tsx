...
const Iridescence = dynamic(() => import("@/components/UIComponents/Iridescence"), {
  ssr: false,
});
const ImageTrail = dynamic(() => import("@/components/UIComponents/ImageTrail"), {
  ssr: false,
...
export default function Trailback() {
  ...
  return (
    <section
      className="relative mx-auto my-12 w-[95%] h-[620px] overflow-hidden rounded-[3rem]
