...
/* -------------------------------------------------------
   PREMIUM GLOW BUTTON
------------------------------------------------------- */
function GlowButton({ text }: { text: string }) {
  return (
    <button className="relative px-6 py-3 rounded-xl bg-black text-white text-sm md:text-base font-medium tracking-wide overflow-hidden shadow-xl">
...
------------------------------------------------------- */
export default function Workshop({ slides }: GitaHomeProps) {
        ...
        <div className="absolute left-0 bottom-0 p-8 max-w-xl text-white font-[Geist_Mono]">
          ...
          {s.title && (
            <motion.h2
              ...
              className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight leading-snug drop-shadow-2xl"
            >
              {s.title}
            </motion.h2>
          )}
          ...
          {s.subtitle && (
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl text-white/90 mt-3 leading-relaxed drop-shadow-lg"
            >
              {s.subtitle}
            </motion.p>
          )}
