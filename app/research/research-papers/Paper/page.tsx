...
export default function PaperPage() {
  ...
  const handleCite = async () => {
    const text =
      `Sharma, A. K. (2025). Planetary Influences on Human Psychology. ` +
  ...
  const handleShare = async () => {
    ...
    const data = {
      ...
      text:
        "A study on how planetary positions influence emotional states and behavior.",
      url,
    };
    if (navigator.share) {
      try {
  ...
  return (
    <main
      ref={rootRef}
      className="min-h-screen w-full bg-gradient-to-b from-white to-neutral-50 dark:from-neutral-950 dark:to-neutral-900"
    >
      {/* Page header bar */}
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:py-10 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <PaperFrame
  src="/Research-paper/Jyotish.pdf"
  title="The Astrology of Seers"
  subtitle="Research Archive • PDF"
  allowDownload={false}
  allowPrint={false}
/>
