...
export default function ProductPage() {
  ...
  const media: CarouselProps["items"] = [
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <ProductBuy
          title="The Nomi Bridal Ring Set"
          sku="RG-NOMI-18Y-DS"
          price={{ mrp: 112900, sale: 106434 }}
          diamondSpec="Preset Solitaire 0.15 Ct + Accent Diamonds 0.237 Ct"
          metalOptions={[
      ...
      <Confused
        title="The Nomi Bridal Ring Set"
        subtitle="The Nomi Bridal Ring Set is a beautiful set of rings that are perfect for a wedding."
