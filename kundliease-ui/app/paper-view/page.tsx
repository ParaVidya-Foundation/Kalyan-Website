    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div
        ...
        className={`bg-white mx-auto shadow-lg print:shadow-none print:mx-0 ${
          paperSize === "a4" ? "max-w-[210mm]" : paperSize === "a3" ? "max-w-[297mm]" : "max-w-[216mm]"
        } ${orientation === "landscape" ? "print:landscape" : ""}`}
        style={{
          minHeight: paperSize === "a4" ? "297mm" : paperSize === "a3" ? "420mm" : "279mm",
        }}
      >
        {/* Header */}
        <div className="p-8 border-b-2 border-orange-200 print:p-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-gray-600">Generated by KundliPro • Professional Vedic Astrology</p>
          </div>
        </div>
        ...
        <div className="p-8 print:p-6">
              ...
              <div className="grid grid-cols-4 gap-0 border-2 border-gray-800 w-80 h-80">
                ...
                {Array.from({ length: 16 }, (_, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`border border-gray-400 flex flex-col items-center justify-center p-1 text-xs ${
                        i === 0 || i === 3 || i === 12 || i === 15 ? "bg-orange-50" : "bg-white"
                      }`}
          ...
          <div className="border-t-2 border-orange-200 pt-6 text-center text-sm text-gray-600">
            ...
            <p className="font-medium text-orange-600">
              Generated by KundliPro • www.kundlipro.com • support@kundlipro.com
            </p>
          </div>
        </div>
      </div>
